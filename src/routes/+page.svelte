<script lang="ts">
	...
	/* TODO
		Přidat načtení prvního layeru v závislosti na pozici vybraného bodu/začátku cesty/1. patro
		Roztřídit seznam cest pomocí ikon
			Administrace (ředitelna, sborovna, (zástupce?), kancelář)
			Kmenové učebny (...)
			Zaměřené učebny (ict, chem lab. chem pos, badatelna........)
			Jazykové učebny (J)
			Kabinety (Kabinaty... (školník?))
			Tělocvičny (TVM a TVV)
			Schodiště (Schody lulw)
			PLACEHOLDER (bufet, knihovna, záchody, vestibul...)
			Ostatní ((školník?), skladiště)
		Zobrazit cestu vestibul->kancelář, ředitelna ....
		Zobrazit prvních 5 nejčastějších cest
		Odstranit skeleton... radši to udělám nějak ručně (nebo musím udělat desing, co sedí na stránky GHB)
		DESIGN :(
		Upravit pro docker
...
<!--TODO funkce, co markery seřadí podle typu (třída, special třída, administrace, schodiště atd...)-->
